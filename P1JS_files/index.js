...
function addTask1(task, origin = "Tasks") {
  ...
  document.querySelector(".myDayCounterSM").textContent = `${getTaksFromLS('myDay').length}`;
  document.querySelector(".myDayCounterMD").textContent = `${getTaksFromLS('myDay').length}`;
  document.querySelector(".myDayCounterLG").textContent = `${getTaksFromLS('myDay').length}`;
...
function addTask2(task, origin = "Important") {
  ...
  document.querySelector(".importantCounterSM").textContent = `${getTaksFromLS('importantTasks').length}`;
  document.querySelector(".importantCounterMD").textContent = `${getTaksFromLS('importantTasks').length}`;
  document.querySelector(".importantCounterLG").textContent = `${getTaksFromLS('importantTasks').length}`;
...
function addTask3(task, origin = "Tasks") {
  ...
  document.querySelector(".myTaskCounterSM").textContent = `${getTaksFromLS('tasks').length}`;
  document.querySelector(".myTaskCounterMD").textContent = `${getTaksFromLS('tasks').length}`;
  document.querySelector(".myTaskCounterLG").textContent = `${getTaksFromLS('tasks').length}`;
}
